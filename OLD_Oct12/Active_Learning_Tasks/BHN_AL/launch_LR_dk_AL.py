...
if subprocess.check_output("hostname").startswith("hades"):
    ...
    job_prefix += "jobdispatch --gpu --queue=gpu_1 --duree=4:00H --env=THEANO_FLAGS=device=gpu,floatX=float32 --project=jvb-000-ag "
else: # TODO: SLURM
    pass
...
grid += [["acq", ['bald']]]
grid += [["lr0", ['.001', '.0005', '.002', '.0002']]]
grid += [["arch", ['hyperCNN', 'CNN_dropout']]]

...
class MCdropoutCNN(object):
    ...
    def __init__(self, dropout=None, dataset='mnist'):
        if dataset == 'mnist':
            ...
            weight_shapes = [(128,3  ,3,3),        
                             (128,128,3,3),      
                             (128,128,3,3),      
                             (128,128,3,3)]
            args = [[128,3,1,'valid',lasagne.nonlinearities.rectify,None ],
                    [128,3,1,'valid',lasagne.nonlinearities.rectify,'max'],
                    [128,3,1,'valid',lasagne.nonlinearities.rectify,None ],
                    [128,3,1,'valid',lasagne.nonlinearities.rectify,'max']]
            num_hids = 512

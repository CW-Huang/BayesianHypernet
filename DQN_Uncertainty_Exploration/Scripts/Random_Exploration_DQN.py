...
for e in range(Experiments):
    ...
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/'  + 'Cum_Rwd_' + 'Only_Random' + str(e) + '.npy', total_reward)
...
np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/'   + 'Average_Cum_Rwd_' + 'Only_Random' + '.npy', Average_Cum_Rwd)


print "All Experiments DONE - Deep Q Learning"

print "Random Exploration DONE"

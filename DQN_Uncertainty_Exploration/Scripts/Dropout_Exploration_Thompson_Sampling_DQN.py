...
def run_episode(env,
    ...
    for i in range(max_step):
        ...
        action = agent.dropout_thompson_act(state)
...
for e in range(Experiments):
    ...
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/'  + 'Cum_Rwd_' + 'Dropout_Thompson_' + str(e) + '.npy', total_reward)
...
np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/'   + 'Average_Cum_Rwd_' + 'Dropout_Thompson_' + '.npy', Average_Cum_Rwd)


print "All Experiments DONE - Deep Q Learning"

print "Dropout + Thompson Sampling Exploration DONE"

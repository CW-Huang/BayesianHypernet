...
np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/'   + 'Average_Cum_Rwd_' + 'Dropout_Boltzmann_' + '.npy', Average_Cum_Rwd)


print "All Experiments DONE - Deep Q Learning"

print "Dropout + Boltzmann Exploration DONE"

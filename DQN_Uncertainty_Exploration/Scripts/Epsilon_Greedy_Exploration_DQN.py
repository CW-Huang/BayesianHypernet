...
for e in range(Experiments):
    ...
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/'  + 'Cum_Rwd_' + 'Only_Epsilon_Greedy_' + str(e) + '.npy', total_reward)
...
np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Exploration_DQN/All_Results/'   + 'Average_Cum_Rwd_' + 'Only_Epsilon_Greedy_' + '.npy', Average_Cum_Rwd)


print "All Experiments DONE - Deep Q Learning"

print "Only Epsilon Greedy Exploration - DONE"

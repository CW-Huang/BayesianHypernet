...
def run_episode(env,
    ...
    for i in range(max_step):
        ...
        action = agent.act_dropout_epsilon_entropy(state)
...
for e in range(Experiments):
    ...
    #np.save('/Users/Riashat/Documents/PhD_Research/Bayesian_DNNs/BayesianHypernet/DQN_Uncertainty_Exploration/MC_Dropout_Scripts/Results/'  + 'Dropout_Epsilon_Entropy_CartPole' + '.npy', Experiments_All_Rewards)
    np.save('/home/ml/rislam4/Documents/BayesianHypernet/DQN_Uncertainty_Exploration/MC_Dropout_Scripts/Results/'  + 'Dropout_Epsilon_Entropy_CartPole' + '.npy', Experiments_All_Rewards)
...
#np.save('/Users/Riashat/Documents/PhD_Research/Bayesian_DNNs/BayesianHypernet/DQN_Uncertainty_Exploration/MC_Dropout_Scripts/Results/'  + 'Average_Dropout_Epsilon_Entropy_CartPole' + '.npy', Average_Cum_Rwd)
np.save('/home/ml/rislam4/Documents/BayesianHypernet/DQN_Uncertainty_Exploration/MC_Dropout_Scripts/Results/'  + 'Average_Dropout_Epsilon_Entropy_CartPole' + '.npy', Average_Cum_Rwd)

...
def run_episode(env,
    ...
    for i in range(max_step):
        ...
        action = agent.act_hypernet_epsilon_entropy(state)
...
for e in range(Experiments):
    ...
    np.save('/Users/Riashat/Documents/PhD_Research/Bayesian_DNNs/BayesianHypernet/DQN_Uncertainty_Exploration/Bayes_Hypernet_Scripts/Results/'  + 'BH_Epsilon_Entropy_CartPole' + '.npy', Experiments_All_Rewards)

env.close()


Average_Cum_Rwd = np.mean(Experiments_All_Rewards, axis=1)
np.save('/Users/Riashat/Documents/PhD_Research/Bayesian_DNNs/BayesianHypernet/DQN_Uncertainty_Exploration/Bayes_Hypernet_Scripts/Results/'  + 'Average_BH_Epsilon_Entropy_CartPole' + '.npy', Average_Cum_Rwd)

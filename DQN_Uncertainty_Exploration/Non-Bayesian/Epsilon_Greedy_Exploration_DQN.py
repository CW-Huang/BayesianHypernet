...
for e in range(Experiments):
    ...
    np.save('/home/ml/rislam4/Documents/BayesianHypernet/DQN_Uncertainty_Exploration/Non-Bayesian/Results/'  + 'Epsilon_Greedy_CartPole' + '.npy', Experiments_All_Rewards)

env.close()


Average_Cum_Rwd = np.mean(Experiments_All_Rewards, axis=1)
np.save('/home/ml/rislam4/Documents/BayesianHypernet/DQN_Uncertainty_Exploration/Non-Bayesian/Results/'  + 'Average_Epsilon_Greedy_CartPole' + '.npy', Average_Cum_Rwd)

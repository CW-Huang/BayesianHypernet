...
for e in range(Experiments):
    ...
    np.save('/Users/Riashat/Documents/PhD_Research/Bayesian_DNNs/BayesianHypernet/DQN_Uncertainty_Exploration/Non-Bayesian/Results/'  + 'Thompson_CartPole' + '.npy', Experiments_All_Rewards)

env.close()


Average_Cum_Rwd = np.mean(Experiments_All_Rewards, axis=1)
np.save('/Users/Riashat/Documents/PhD_Research/Bayesian_DNNs/BayesianHypernet/DQN_Uncertainty_Exploration/Non-Bayesian/Results/'  + 'Average_Thompson_CartPole' + '.npy', Average_Cum_Rwd)
